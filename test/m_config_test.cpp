...
TEST_F(MConfig, MParseCommandLine)
{
    ...
    result = M_ParseCommandLine(3, argv.data(), CommandLinePass::early, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
    ASSERT_TRUE(Pwad_list.empty());
    // Second pass uses it
    result = M_ParseCommandLine(3, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	...
	result = M_ParseCommandLine(2, argv.data(), CommandLinePass::early, Pwad_list, options().data());
	ASSERT_FALSE(result.success);
	ASSERT_TRUE(result.message.startsWith("unknown option"));
	result = M_ParseCommandLine(2, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_FALSE(result.success);
	ASSERT_TRUE(result.message.startsWith("unknown option"));
    Pwad_list.clear();
	...
	result = M_ParseCommandLine(2, argv.data(), CommandLinePass::early, Pwad_list, options().data());
	ASSERT_FALSE(result.success);
	ASSERT_TRUE(result.message.startsWith("missing argument"));
	Pwad_list.clear();
	...
	argv = { "-v" };
	result = M_ParseCommandLine(1, argv.data(), CommandLinePass::early, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	...
	result = M_ParseCommandLine(5, argv.data(), CommandLinePass::early, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	ASSERT_TRUE(Pwad_list.empty());
	// On pass 2, they get combined
	result = M_ParseCommandLine(5, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	...
	result = M_ParseCommandLine(8, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	ASSERT_EQ(Pwad_list.size(), 4);
	ASSERT_EQ(Pwad_list[0], "loose file.wad");
	ASSERT_EQ(Pwad_list[1], "");
	...
	result = M_ParseCommandLine(4, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	...
	result = M_ParseCommandLine(7, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	...
	result = M_ParseCommandLine(11, argv.data(), CommandLinePass::normal, Pwad_list, options().data());
	ASSERT_TRUE(result.success);
	ASSERT_EQ(Pwad_list.size(), 4);
	ASSERT_EQ(Pwad_list[0], "file1");
	ASSERT_EQ(Pwad_list[1], "file2");
...
TEST_F(MConfig, MParsePathListCommandLine)
{
	...
	ReportedResult result = M_ParseCommandLine((int)argv.size(), argv.data(), CommandLinePass::normal, Pwad_list,
					   options().data());
	ASSERT_TRUE(result.success);
