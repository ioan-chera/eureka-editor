...
#ifdef WIN32
		snprintf(filename, sizeof(filename), "%s/common/about_logo.png", config::install_dir.c_str());
#else
		snprintf(filename, sizeof(filename), "%s/about_logo.png", config::install_dir.c_str());
#endif
