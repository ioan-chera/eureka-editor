...
static Fl_Menu_Item ted_menu_items[] =
{
	{ "&File", 0, 0, 0, FL_SUBMENU },
		...
		{ "&Export to File\u2026  ", FL_COMMAND + 'e', FCAL UI_TextEditor::menu_do_export, 0, FL_MENU_DIVIDER },
		{ "&Save Lump",   FL_COMMAND + 's', FCAL UI_TextEditor::menu_do_save, 0, FL_MENU_DIVIDER },
		{ "&Close",       FL_COMMAND + 'q', FCAL UI_TextEditor::menu_do_close },
		{ 0 },

	{ "&Edit", 0, 0, 0, FL_SUBMENU },
		{ "&Undo",    FL_COMMAND + 'z',  FCAL UI_TextEditor::menu_do_undo, 0, FL_MENU_DIVIDER },
		...
		{ "&Delete",  0,                 FCAL UI_TextEditor::menu_do_delete, 0, FL_MENU_DIVIDER },
	...
	{ "&Search", 0, 0, 0, FL_SUBMENU },
		...
		{ "Find &Prev", FL_COMMAND + 'p',  FCAL UI_TextEditor::menu_do_find_prev, 0, FL_MENU_DIVIDER },
